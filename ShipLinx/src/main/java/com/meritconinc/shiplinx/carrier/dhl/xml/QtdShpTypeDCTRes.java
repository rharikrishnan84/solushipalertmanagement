...
/**
 * <p>Java class for QtdShpType complex type.
 * 
...
@XmlType(name = "QtdShpType", namespace = "http://www.dhl.com/DCTResponsedatatypes", propOrder = {
    "globalProductCode",
    "localProductCode",
    "productShortName",
    "localProductName",
    ...
    "deliveryCheckpointReturn",
    "deliveryDate",
    "deliveryTime",
    "deliveryTimeGMTOffset",
    "dimensionalWeight",
    "weightUnit",
    "pickupDayOfWeekNum",
...
public class QtdShpTypeDCTRes {
    ...
    protected List<QtdShpExChrgTypeDCTRes> qtdShpExChrg;
     ...
     * This is why there is not a <CODE>set</CODE> method for the qtdShpExChrg property.
     * 
     * <p>
     ...
     * {@link QtdShpExChrgTypeDCTRes }
     * 
     * 
     */
    public List<QtdShpExChrgTypeDCTRes> getQtdShpExChrg() {
        if (qtdShpExChrg == null) {
            qtdShpExChrg = new ArrayList<QtdShpExChrgTypeDCTRes>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the weightChargeTaxDet property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
