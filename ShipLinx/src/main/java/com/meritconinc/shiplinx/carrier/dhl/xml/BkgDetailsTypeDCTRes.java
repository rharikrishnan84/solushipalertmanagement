...
public class BkgDetailsTypeDCTRes {
    ...
    protected List<QtdShpTypeDCTRes> qtdShp;
     ...
     * {@link QtdShpTypeDCTRes }
     * 
     * 
     */
    public List<QtdShpTypeDCTRes> getQtdShp() {
        if (qtdShp == null) {
            qtdShp = new ArrayList<QtdShpTypeDCTRes>();
        }
        return this.qtdShp;
    }
