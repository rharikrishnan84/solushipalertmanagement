...
@XmlSeeAlso({
    ModifyPickUpResponseContainer.class,
    SchedulePickUpResponseContainer.class,
    GetPickUpHistoryResponseContainer.class,
    ValidatePickUpResponseContainer.class,
    VoidPickUpResponseContainer.class
})
