...
public class DhlInternalServiceCodeComparator implements Comparator<String> {

	private static HashMap<String, Integer> productMap;

	public DhlInternalServiceCodeComparator() {
		if (productMap == null) {
	...
	public int compare(String iSC1, String iSC2) {
		...
		} else if (!productMap.containsKey(iSC1)
				&& productMap.containsKey(iSC2)) {
