...
@XmlType(name = "BkgDetailsType", namespace = "http://www.dhl.com/DCTRequestdatatypes", propOrder = {
    "paymentCountryCode",
    "date",
    "readyTime",
    "readyTimeGMTOffset",
...
public class BkgDetailsType {
     ...
     * This is why there is not a <CODE>set</CODE> method for the numberOfPieces property.
     * 
     * <p>
