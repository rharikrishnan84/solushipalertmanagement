 ...
 *         &lt;element name="InternationalInformation" type="{http://purolator.com/pws/datatypes/v1}InternationalInformation" minOccurs="0"/>
 *         &lt;element name="ReturnShipmentInformation" type="{http://purolator.com/pws/datatypes/v1}ReturnShipmentInformation" minOccurs="0"/>
...
public class Shipment {
    ...
    @XmlElementRef(name = "InternationalInformation", namespace = "http://purolator.com/pws/datatypes/v1", type = JAXBElement.class)
    protected JAXBElement<InternationalInformation> internationalInformation;
    @XmlElementRef(name = "ReturnShipmentInformation", namespace = "http://purolator.com/pws/datatypes/v1", type = JAXBElement.class)
    protected JAXBElement<ReturnShipmentInformation> returnShipmentInformation;
    ...
    /**
     * Gets the value of the internationalInformation property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link InternationalInformation }{@code >}
     *     
     */
    public JAXBElement<InternationalInformation> getInternationalInformation() {
        return internationalInformation;
    }

    /**
     * Sets the value of the internationalInformation property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link InternationalInformation }{@code >}
     *     
     */
    public void setInternationalInformation(JAXBElement<InternationalInformation> value) {
        this.internationalInformation = value;
    }

    /**
     * Gets the value of the returnShipmentInformation property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ReturnShipmentInformation }{@code >}
     *     
     */
    public JAXBElement<ReturnShipmentInformation> getReturnShipmentInformation() {
        return returnShipmentInformation;
    }

    /**
     * Sets the value of the returnShipmentInformation property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ReturnShipmentInformation }{@code >}
     *     
     */
    public void setReturnShipmentInformation(JAXBElement<ReturnShipmentInformation> value) {
        this.returnShipmentInformation = value;
    }
