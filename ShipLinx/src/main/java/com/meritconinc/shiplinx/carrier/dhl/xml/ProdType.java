...
@XmlType(name = "ProdType", namespace = "http://www.dhl.com/DCTResponsedatatypes", propOrder = {
    "vldSrvComb"
})
public class ProdType {
     ...
     * This is why there is not a <CODE>set</CODE> method for the vldSrvComb property.
     * 
     * <p>
    ...
    public static class VldSrvComb {
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the localServiceType property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the combRSrv property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
        ...
        public static class CombRSrv {
             ...
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the JAXB object.
             * This is why there is not a <CODE>set</CODE> method for the restrictedLocalServiceType property.
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * <pre>
