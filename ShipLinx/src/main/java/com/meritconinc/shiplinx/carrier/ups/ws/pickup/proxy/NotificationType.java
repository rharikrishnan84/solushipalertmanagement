 ...
 *       &lt;sequence>
 *         &lt;element name="ConfirmationEmailAddress" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
public class NotificationType {
    ...
    protected List<String> confirmationEmailAddress;
     ...
     * This is why there is not a <CODE>set</CODE> method for the confirmationEmailAddress property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getConfirmationEmailAddress().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getConfirmationEmailAddress() {
        if (confirmationEmailAddress == null) {
            confirmationEmailAddress = new ArrayList<String>();
        }
