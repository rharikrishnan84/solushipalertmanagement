 ...
 <table border="0" cellspacing="0" cellpadding="2" style="padding-right:15px;padding-left:15px;" >
	...
	<tr>
		...
		<table border="0" cellpadding="3" cellspacing="0" class="text_01">
			<tr>
				<td valign="middle" class="text_03"><mmr:message messageId="label.shippingOrder.additionalServices.weight"/></td>
				<td><s:select name="shippingOrder.packages[0].weight" cssStyle="width: 120px;" value="%{shippingOrder.packages[0].weight}" list="{1,2,3}" cssClass="text_01"/>
				</td>
			</tr>
			<tr>
