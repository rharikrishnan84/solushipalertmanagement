								...
								<div class="content_header" style="margin-top:1px; margin-bottom:1px;">
									...
									<div class="form_buttons">
										...
										<a class="referenceClose" onclick="javascript:return false;" style="padding:0px; background-color:transparent;" href="">
											<img src="/shiplinx/mmr/images/show.png">
										</a>
									</div>
								</div>
...
<div class="content_table" style="margin-top:1px;">
	...
	<div class="content_body">	
	                  ...
	                  id="billToACountry" theme="simple" disabled="true"/>
									...
									<s:if test="%{!(#session.ROLE.contains('customer_shipper') || #session.ROLE.contains('sales')) }">
									<div class="form_buttons id="img_get_rates1" style=" width:300px; float:right !important; padding-right:3px;">
											<div align="left" style="float:right !important;" id="get_rates_td"><a href="javascript:getRates()" onclick="return (validateOrder(3,1))">Create</a></div>
										</div>
									</s:if>
									</div>
								</div>
