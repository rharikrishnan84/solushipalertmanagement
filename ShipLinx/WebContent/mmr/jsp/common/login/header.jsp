	  	...
	  	<div id="main_tabs" style="margin-bottom:5px;">
			<table width="612" border="0" cellspacing="0" cellpadding="0">
			  <tr>
			    ...
			    <td width="153" background="<%=request.getContextPath()%>/mmr/images/red_middle_big.gif" class="tab_text"><a href="<%=request.getContextPath()%>/viewLogon.action">Package / Envelope </a></td>
			    <td width="12"><img src="<%=request.getContextPath()%>/mmr/images/red_right_big.gif" width="12" height="33" /></td>
				...
				<td width="5"><img src="<%=request.getContextPath()%>/mmr/images/spacer_white.gif" width="5" height="5" /></td>
			    <td width="13"><img src="<%=request.getContextPath()%>/mmr/images/grey_left_big.gif" width="13" height="33" /></td>
			    <td width="159" background="<%=request.getContextPath()%>/mmr/images/grey_middle_big.gif" class="tab_text"><a href="<%=request.getContextPath()%>/officeService.action">Office / Print Services</a></td>
			    <td width="54"><img src="<%=request.getContextPath()%>/mmr/images/grey_right_big.gif" width="13" height="33" /></td>
			  </tr>
			</table>
	  	</div>
	</div>
