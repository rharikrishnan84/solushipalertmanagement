	  	...
	  	<div id="main_tabs" style="margin-bottom:5px;">
			<table width="612" border="0" cellspacing="0" cellpadding="0">
			  <tr>
			    ...
			    <td width="76" background="<%=request.getContextPath()%>/mmr/images/red_middle_big.gif" class="tab_text"><a href="<%=request.getContextPath()%>/expedited.action">Expedited</a></td>
			    <td width="13"><img src="<%=request.getContextPath()%>/mmr/images/red_right_big.gif" width="13" height="33" /></td>
