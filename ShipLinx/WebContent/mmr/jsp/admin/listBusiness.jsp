...
<SCRIPT language="JavaScript">
	...
	<script type="text/javascript">
		function addBusiness(){
			document.getElementById("searchUserFormId").action = "new.business.action";
			document.getElementById("searchUserFormId").submit();
...
<script type="text/javascript">
		...
		//	alert('Do you really want to apply the selected markup to all customers?');
				...
				document.getElementById("searchUserFormId").action = "edit.business.action?businessId="+txt;
				document.getElementById("searchUserFormId").submit();
			}
		}
	</script>
		...
		<tbody>
          ...
          <s:iterator id="artable" value="businessList" status="rowstatus">
             <tr>
	           ...
	           <td style="text-align: left;"><span title="<s:property value="name"/>"></span><div style="width:170px;overflow:hidden;white-space:nowrap;text-overflow: ellipsis"><s:property value="name"/></div></td>
