...
<SCRIPT language="JavaScript">
	...
	<script type="text/javascript">
		function addBusiness(){
			document.getElementById("searchUserFormId").action = "addPartner.action";
			document.getElementById("searchUserFormId").submit();
...
<script type="text/javascript">
		...
		//	alert('Do you really want to apply the selected markup to all customers?');
				...
				document.getElementById("searchUserFormId").action = "edit.partner.action?businessId="+txt;
				document.getElementById("searchUserFormId").submit();
			}
		}
	</script>
...
<div class="content_table" style="background-color:#fff">
	...
	<div id="srchusr_res"><span> Partner List</span></div>
		<div class="form_buttons" style="float:right;">
			...
			<li><a href="#" onclick="addBusiness();">Add Partner</a></li>
			...
			<li><a href="#" onclick="viewBusiness();">View Partner</a></li>
			</s:elseif>
			</ul>
		</div>	
	</div>
          ...
          <s:iterator id="artable" value="businessList" status="rowstatus">
             <tr>
		          ...
		          <input  id="" class="dataTable-checkbox" type="checkbox" name="searchMenu" value="<s:property value="id"/>"/>  </td>
		          	<td> <a href="login.partner.action?partnerParam=${id}" class="arrowPackage"> >>
