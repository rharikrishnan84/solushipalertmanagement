...
window.onload = function() {
	...
	function submitform()
	{
		...
		document.userform.action = "createPartner.action";
...
<s:form action="createUser" name="userform" style="margin-bottom	:0px">
							...
							<div class="rows">
								<div class="fields">
										...
										<div class="controls"><span>:</span>
										 <label>
										 <s:property value="%{partner.partnerName}"/>
										 </label>
										 </div>
									</div>
									<div class="fields">
										...
										<div  class="controls"><span>:</span>
										<label>
										<s:property value="%{partner.firstName}"/>
										</label>
										</div>
									</div>
									...
									<div class="fields">
										...
										<div class="controls"><span>:</span>
											<label>
										<s:property value="%{partner.lastName}"/>
										</label>
										</div>
									</div>
									
									<div class="fields">
										<label><mmr:message messageId="label.partner.shortCode"/> SHORT CODE </label>
										<div  class="controls"><span>:</span>
											<label>
										<s:property value="%{partner.shortCode}"/>
										</label>
										</div>
									</div>
									<div class="fields">
										...
										<div class="controls"><span>:</span>
											<label>
										<s:property value="%{partner.phoneNumber}"/>
										</label>
										</div>
									</div>
										<div class="fields">
								   ...
								   <div class="fields">
										...
										<div  class="controls"><span>:</span>
											<label>
										<s:property value="%{partner.email}"/>
										</label>
										</div>
									</div>
					...
					<div class="cont_hdr_title">
							...
							<div class="rows">
									...
									<div class="fields">
											...
											<div class="controls"><span>:</span>
										 <label>
										    <s:property value="%{partner.partnerAddress.address1}"/>
										</label>
										...
										<div class="fields">
											...
											<div class="controls"><span>:</span>
												 <label>
										    <s:property value="%{partner.partnerAddress.address2}"/>
										</label>
											</div>
										</div>
										<div class="fields">
	    	                               ...
	    	                               <label>
										    <s:property value="%{partner.partnerAddress.postalCode}"/>
										</label>
											</div>
										</div>
										<div class="fields">
	                  ...
	                  onchange="javascript:showShipFromState();" disabled="%{partner.partnerAddress.countryCode!=null || partner.partnerAddress!=null }"  id="firstBox"  theme="simple"/>
											</div>
										</div>
										<div class="fields">
	    	                               ...
	    	                               <label>
										    <s:property value="%{partner.partnerAddress.provinceCode}"/>
										</label>
           ...
           <div class="controls"> <span>:</span>
            							  <label>
										    <s:property value="%{partner.partnerAddress.city}"/>
										</label>
            </div>
           </div>
										<div class="fields">
											...
											<div class="controls"><span>:</span>
												 ...
												 <label>
										    <s:property value="%{partner.partnerAddress.phoneNo}"/>
										</label>
											</div>
										</div>
										<div class="fields">
										...
										<div class="fields">
											...
											<div class="controls"><span>:</span>
										 <label>
										    <s:property value="%{partner.partnerAddress.contactName}"/>
										</label>
											</div>
										</div>
										<div class="fields">
											...
											<div class="controls"><span>:</span>
										  <label>
										    <s:property value="%{partner.partnerAddress.instruction}"/>
										</label>
											</div>
										</div>
