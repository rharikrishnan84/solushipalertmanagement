...
<SCRIPT language="JavaScript">
	...
	<script type="text/javascript">
		function addBusiness(){
			document.getElementById("searchUserFormId").action = "addbranch.action";
			document.getElementById("searchUserFormId").submit();
...
<script type="text/javascript">
		...
		//	alert('Do you really want to apply the selected markup to all customers?');
				...
				document.getElementById("searchUserFormId").action = "edit.branch.action?businessId="+txt;
				document.getElementById("searchUserFormId").submit();
			}
		}
	</script>
...
<div class="content_table" style="background-color:#fff">
	...
	<div id="srchusr_res"><span> Branch List</span></div>
		<div class="form_buttons" style="float:right;">
			...
			<li><a href="#" onclick="addBusiness();">Add Branch</a></li>
			...
			<li><a href="#" onclick="viewBusiness();">View Branch</a></li>
			</s:elseif>
			</ul>
		</div>	
	</div>
