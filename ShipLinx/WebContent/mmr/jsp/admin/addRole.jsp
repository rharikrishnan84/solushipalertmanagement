...
window.onload = function() {
	...
	function submitform()
	{
	 			document.userform.action = "save.role.action";
...
<s:form action="createUser" name="userform" style="margin-bottom	:0px">
    ...
    <s:hidden name="roleid" value="%{roleVO.role}" />
						<div class="content_table">
							<div class="content_header">
								<div class="cont_hdr_title">
									<s:if test="#session.roleEdit == 'true'">
									<mmr:message messageId="role.admin.roleHeader"/>
									
									</s:if>
									<s:else>
									<mmr:message messageId="label.role.newRole"/>
								</s:else>
								</div>
							...
							<div class="cont_data_body">
								<div class="rows">
								<div class="fields">
										<label><mmr:message messageId="label.role.roleName"/> </label>
										<div class="controls"><span>:</span>
										<s:textfield   id="roleName" key="roleVO.role" name="roleVO.role"  onkeypress="return typenumbers(event,\'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-.@\')"/>
									</div>
									</div>
									<div class="fields">
										<label><mmr:message messageId="label.role.roleDescription"/> </label>
										<div class="controls"><span>:</span>
										<s:textfield   id="roleDescription" key="roleVO.description" name="roleVO.description"  onkeypress="return typenumbers(event,\'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-.@\')"/>
									</div>
									</div>
						...
						<div class="content_table">
							<div class="content_header">
								<div class="cont_hdr_title"><mmr:message messageId="label.role.actions"/></div>
							</div>
							<div class="cont_data_body">
							
								<div class="rows">
									<div class="fields1">
										<label><mmr:message messageId="label.role.roleActions"/> : </label>
										<div class="controls">
										<s:select   name="roleVO.actionIds" value="%{selectedActionIds}"  listKey="id" listValue="actionKey" cssClass="changerole"
										  list="actionVO" theme="simple"  id="idLocale" multiple="true"
							...
							<div class="cont_data_body">
								...
								<div class="rows">
									<div class="fields1">
										...
										<div class="controls1"> 
										<s:select   name="roleVO.menuIds" value="%{selectedMenuIds}"  listKey="id" listValue="name" cssClass="changerole"
										 list="menuVo" theme="simple"  id="idLocale" multiple="true"
										cssStyle="width:150px;height:100px"/>
									</div>
									</div>
