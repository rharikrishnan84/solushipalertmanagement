...
#Action Drop down for csv ,xl ,xml

INSERT INTO `resourcebundle` (`msg_id`, `msg_content`, `locale`, `is_fmk`) VALUES ('label.list.csv', 'Export to: CSV', 'en_CA', 0);
INSERT INTO `resourcebundle` (`msg_id`, `msg_content`, `locale`, `is_fmk`) VALUES ('label.list.xl', 'Export to: XL', 'en_CA', 0);
INSERT INTO `resourcebundle` (`msg_id`, `msg_content`, `locale`, `is_fmk`) VALUES ('label.list.xml', 'Export to: XML', 'en_CA', 0);
INSERT INTO `resourcebundle` (`msg_id`, `msg_content`, `locale`, `is_fmk`) VALUES ('label.list.manifest.eod', 'Export to: EOD', 'en_CA', 0);
INSERT INTO `resourcebundle` (`msg_id`, `msg_content`, `locale`, `is_fmk`) VALUES ('label.list.midland.eod', 'Export to: Midland EOD', 'en_CA', 0);

#selva email issue 

CREATE TABLE `business_contact` (
  `business_contact_id` INT NOT NULL AUTO_INCREMENT,
  `business_abbreviation` VARCHAR(100) NULL,
  `quick_start_url` VARCHAR(150) NULL,
  `admin_email` VARCHAR(45) NULL,
  `ar_ctc` TEXT NULL,
  `ar_phone` VARCHAR(45) NULL,
  `ar_email` VARCHAR(45) NULL,
  `ltl_ctc` TEXT NULL,
  `ltl_phone` VARCHAR(45) NULL,
  `ltl_email` VARCHAR(45) NULL,
  PRIMARY KEY (`business_contact_id`));

INSERT INTO `resourcebundle` (`msg_id`, `msg_content`, `locale`, `is_fmk`) VALUES ('label.buisness.contact.businesssAbbrivation', 'Business Abbrevation Name', 'en_CA', 1);
INSERT INTO `resourcebundle` (`msg_id`, `msg_content`, `locale`, `is_fmk`) VALUES ('label.buisness.contact.ltlContact', 'LTL Contact', 'en_CA', 1);
INSERT INTO `resourcebundle` (`msg_id`, `msg_content`, `locale`, `is_fmk`) VALUES ('label.buisness.contact.arEmail', 'AR Email', 'en_CA', 1);
INSERT INTO `resourcebundle` (`msg_id`, `msg_content`, `locale`, `is_fmk`) VALUES ('label.buisness.contact.arPhone', 'AR Phone', 'en_CA', 1);
INSERT INTO `resourcebundle` (`msg_id`, `msg_content`, `locale`, `is_fmk`) VALUES ('label.buisness.contact.arContact', 'AR Contact', 'en_CA', 1);
INSERT INTO `resourcebundle` (`msg_id`, `msg_content`, `locale`, `is_fmk`) VALUES ('label.buisness.contact.adminEmail', 'Business Admin Email', 'en_CA', 1);
INSERT INTO `resourcebundle` (`msg_id`, `msg_content`, `locale`, `is_fmk`) VALUES ('label.buisness.contact.quickStartUrl', 'Quick Start URL', 'en_CA', 1);
INSERT INTO `resourcebundle` (`msg_id`, `msg_content`, `locale`, `is_fmk`) VALUES ('label.buisness.contact.businessContactUrl', 'Business Contact URL', 'en_CA', 1);
INSERT INTO `resourcebundle` (`msg_id`, `msg_content`, `locale`, `is_fmk`) VALUES ('label.buisness.contact.ltlPhone', 'LTL Phone', 'en_CA', 1);
INSERT INTO `resourcebundle` (`msg_id`, `msg_content`, `locale`, `is_fmk`) VALUES ('label.buisness.contact.ltlEmail', 'LTL Email', 'en_CA', 1);


UPDATE `resourcebundle` SET `msg_content`='<html>\n<head>\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />\n<title>Welcome to %BUSINESSABBRIVATION SoluShip&trade;</title>\n<style type=\"text/css\">\n<!--\nbody {\n	font: 100% Verdana, Arial, Helvetica, sans-serif;\n	background: #fff;\n	margin: 0;\n	padding: 0;\n	text-align: center;\n	color: #000000;\n}\n.oneColElsCtr #container {\n	width: 550px;\n	background: #FFFFFF;\n	margin: 0 auto;\n	border: 1px solid #000000;\n	text-align: left;\n	height:auto;\n}\n.oneColElsCtr #mainContent {\n	padding: 10px 10px 10px 10px;\n	font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n	font-size: 12px;\n}\n.oneColElsCtr #mainContent h1 {\n	padding: 5px 0px 0px 0px;\n	font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n	font-size: 18px;\n	color:#990000;\n}\n.oneColElsCtr #mainFooter {\n	padding: 5px 0px 0px 10px;\n	font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n	font-size: 10px;\n	color:#fff;\n	background-color:#000000;\n	height:35px;\n}\n#mainContent p{\ntext-align: left;\n}\n-->\n</style>\n</head>\n\n<body class=\"oneColElsCtr\">\n\n<div id=\"container\">\n<img src=\"http://www.soluship.com/mmr/images/ic-header.jpg\" includeContext=\"true\" />\n  <div id=\"mainContent\">\n    <h1> <SPAN style=\"color : %BUSINESSCOLOR\">Welcome to  %BUSINESSABBRIVATION SoluShip&trade;</SPAN> </h1>\n    <p>Dear Valued Customer,</p>\n    <p>Please find attached a copy of your invoice as requested. </p>\n    <p>If you have any questions in regards to this invoice please contact  <SPAN style=\"color : %BUSINESSCOLOR\"> %ARCONTACT  at %ARPHONE</SPAN> ext 4\nor by email at <a href=\"mailto:%AREMAIL\" style=\"color : %BUSINESSCOLOR ;\">%AREMAIL</a></p>\n    <p>Thank you and enjoy <SPAN style=\"color : %BUSINESSCOLOR\">%BUSINESSABBRIVATION</SPAN> SoluShip&trade;.</p><br/>\n	<!-- end #mainContent -->\n    </div>\n    <div id=\"mainFooter\">\n   	%FOOTER\n    <!-- end #mainFooter -->\n    </div>\n<!-- end #container -->\n</div>\n</body>\n</html>' WHERE `resourcebundle_id`='1495' and`msg_id`='message.send.invoice.notification.body' and`locale`='en_CA' and`is_fmk`=0;
UPDATE `resourcebundle` SET `msg_content`='\n\n <html>\n  <head>\n  <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />\n  <title>Thank you for using %BUSINESSABBRIVATION SoluShip&trade;</title>\n  <style type=\"text/css\">\n  <!--\n  body {\n  font: 100% Verdana, Arial, Helvetica, sans-serif;\n  background: #fff;\n  margin: 0;\n  padding: 0;\n  text-align: center;\n  color: #000000;\n  }\n  .oneColElsCtr #container {\n  width: 550px;\n  background: #FFFFFF;\n  margin: 0 auto;\n  border: 1px solid #000000;\n  text-align: left;\n  height:auto;\n  }\n  .oneColElsCtr #mainContent {\n  padding: 10px 10px 10px 10px;\n  font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n  font-size: 12px;\n  }\n  .oneColElsCtr #mainContent h1 {\n  padding: 5px 0px 0px 0px;\n  font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n  font-size: 18px;\n  color:#990000;\n  }\n  .oneColElsCtr #mainFooter {\n  padding: 5px 0px 0px 10px;\n  font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n  font-size: 10px;\n  color:#fff;\n  background-color:#000000;\n  height:35px;\n  }\n  #mainContent p{\n  text-align: left;\n  margin-left: 30px;\n  }\n  ul{\n  text-align: left;  }\n  -->\n  </style>\n  </head>\n  \n  <body class=\"oneColElsCtr\">\n  \n  <div id=\"container\">\n\n  <img src=\"http://www.soluship.com/mmr/images/ic-header.jpg\" includeContext=\"true\" />\n    <div id=\"mainContent\">\n      <h1>Thank you for using <SPAN style=\"color : %BUSINESSCOLOR\">%BUSINESSABBRIVATION</SPAN> SoluShip&trade;</h1>\n      <p>Dear Customer,</p>\n      <p>Thank you for your inquiry. We are pleased to present you this quote based on the shipping details below.</p>\n      <p>-------------------------------------------------------</p>\n      <p>\n  <b>Ship From:</b><br/>\n  City: %SFROMCITY<br/>\n  Zip/Postal Code: %SFROMZIP<br/>\n  Province: %SFROMPROVINCE<br/>\n  Country: %SFROMCOUNTRY<br/>\n      </p>\n      <p>-------------------------------------------------------</p>\n      <p>\n  <b>Ship To:</b><br/>\n  City: %STOCITY<br/>\n  Zip/Postal Code: %STOZIP<br/>\n  Province: %STOPROVINCE<br/>\n  Country: %STOCOUNTRY<br/>\n      </p>\n      <p>-------------------------------------------------------</p>\n      <p>Carrier and Service: %CARRIERSERVICE</p>\n      <p>-------------------------------------------------------</p>\n      <p>Transit Time: %TRANSITDAYS</p>\n      <p>-------------------------------------------------------</p>\n      <p>Total Weight: %TOTALWEIGHT</p>\n      <p>-------------------------------------------------------</p>\n      <p>Total Charges: %TOTALCHARGES</p>\n      <p>%CHARGEDETAILS</p>\n      <p>-------------------------------------------------------</p>\n      <p>Package Details:</p>\n      <p>%PACKAGEDETAILS</p>\n      <p>-------------------------------------------------------</p>\n  <p>%ADDITIONALSERVICESTITLE</p>\n      <p>%ADDITIONALSERVICES</p>\n      <p>%ENDLINE</p>\n  <br/>\n  \n      <p>If you have any questions in regards to this quote please contact us at <span style=\"color : %BUSINESSCOLOR ;\">%LTLPHONE</span> ext %VALUE\n  or by email at <a href=\"mailto:%LTLEMAIL\" style=\"color : %BUSINESSCOLOR ;\">%LTLEMAIL</a>\n\n</p>\n      <p>Thank you and enjoy <SPAN style=\"color : %BUSINESSCOLOR\">%BUSINESSABBRIVATION</SPAN> SoluShip&trade;.</p><br/>\n  <!-- end #mainContent -->\n      </div>\n      <div id=\"mainFooter\">\n     %FOOTER\n      <!-- end #mainFooter -->\n      </div>\n  <!-- end #container -->\n  </div>\n  </body>\n  </html>' WHERE `resourcebundle_id`='1499' and`msg_id`='message.send.rates.notification.body' and`locale`='en_CA' and`is_fmk`=0;
UPDATE `resourcebundle` SET `msg_content`='<html>\n<head>\n <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />\n <title>%BUSINESSABBRIVATION SoluShip&trade;</title>\n <style type=\"text/css\">\n <!--\n body {\n font: 100% Verdana, Arial, Helvetica, sans-serif;\n background: #fff;\n margin: 0;\n padding: 0;\n text-align: center;\n color: #000000;\n }\n .oneColElsCtr #container {\n width: 550px;\n background: #FFFFFF;\n margin: 0 auto;\n border: 1px solid #000000;\n text-align: left;\n height:auto;\n }\n .oneColElsCtr #mainContent {\n padding: 10px 10px 10px 10px;\n font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n font-size: 12px;\n }\n .oneColElsCtr #mainContent h1 {\n padding: 5px 0px 0px 0px;\n font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n font-size: 18px;\n color:#990000;\n }\n .oneColElsCtr #mainFooter {\n padding: 5px 0px 0px 10px;\n font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n font-size: 10px;\n color:#fff;\n background-color:#000000;\n height:35px;\n }\n #mainContent p{\n text-align: left;\n margin-left: 30px;\n }\n ul{\n text-align: left;\n }\n -->\n </style>\n </head>\n\n <body class=\"oneColElsCtr\">\n\n <div id=\"container\">\n <img src=\"http://www.soluship.com/mmr/images/ic-header.jpg\" includeContext=\"true\" />\n <div id=\"mainContent\">\n <h1><SPAN style=\"color : %BUSINESSCOLOR ;\">%BUSINESSABBRIVATION SoluShip&trade;</SPAN></h1>\n <p>A shipment has been  <SPAN style=\"color : %BUSINESSCOLOR ;\"> cancelled.</span> Details are as follows.</p>\n <p>This e-mail confirms receipt of your shipment request for %ShipDate.</p>\n <p>\n <b>Ship From:</b><br/>\n Company: %SFROMCOMPANY<br/>\n Address: %SFROMADDRESS1, %SFROMADDRESS2%<br/>\n City: %SFROMCITY<br/>\n Zip/Postal Code: %SFROMZIP<br/>\n Province: %SFROMPROVINCE<br/>\n Country: %SFROMCOUNTRY<br/>\n </p>\n <p>\n <b>Ship To:</b><br/>\n Company: %STOCOMPANY<br/>\n Address: %STOADDRESS1, %STOADDRESS2%<br/>\n City: %STOCITY<br/>\n Zip/Postal Code: %STOZIP<br/>\n Province: %STOPROVINCE<br/>\n Country: %STOCOUNTRY<br/>\n </p>\n <p><b>Carrier and Service:</b> %CARRIERSERVICE</p>\n <p><b>Total Pieces:</b> %TOTALPIECES<br/>\n <b>Total Weight:</b> %TOTALWEIGHT</p>\n <p><b>Tracking Details:</b>%TRACKINGURL</br>\n </p>\n <p><b>Pickup Confirmation Number:</b>%PICKUPCONFIRMATION</br>\n </p>\n <p>Did you know you can create and track shipments and get estimates and transit times online at <a href=\"%BUSINESSLOGOUTURL\" style=\"color : %BUSINESSCOLOR ;\">%BUSINESSLOGOUTURL</a> Visit our website today and learn how our online services can benefit you.</br>\n </p>\n <p>Thank you for choosing <span style=\"color : %BUSINESSCOLOR ;\"> %BUSINESSNAME.</span></p>\n\n\n <br/>\n\n <!-- end #mainContent -->\n </div>\n <div id=\"mainFooter\">\n %FOOTER\n <!-- end #mainFooter -->\n </div>\n <!-- end #container -->\n </div>\n </body>\n </html>' WHERE `resourcebundle_id`='1672' and`msg_id`='mail.cancel.shipment.notification.body' and`locale`='en_CA' and`is_fmk`=0;
UPDATE `resourcebundle` SET `msg_content`='<html>\n<head>\n <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />\n <title>%BUSINESSABBRIVATION SoluShip&trade;</title>\n <style type=\"text/css\">\n <!--\n body {\n font: 100% Verdana, Arial, Helvetica, sans-serif;\n background: #fff;\n margin: 0;\n padding: 0;\n text-align: center;\n color: #000000;\n }\n .oneColElsCtr #container {\n width: 550px;\n background: #FFFFFF;\n margin: 0 auto;\n border: 1px solid #000000;\n text-align: left;\n height:auto;\n }\n .oneColElsCtr #mainContent {\n padding: 10px 10px 10px 10px;\n font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n font-size: 12px;\n }\n .oneColElsCtr #mainContent h1 {\n padding: 5px 0px 0px 0px;\n font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n font-size: 18px;\n color:#990000;\n }\n .oneColElsCtr #mainFooter {\n padding: 5px 0px 0px 10px;\n font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n font-size: 10px;\n color:#fff;\n background-color:#000000;\n height:35px;\n }\n #mainContent p{\n text-align: left;\n margin-left: 30px;\n }\n ul{\n text-align: left;\n }\n -->\n </style>\n </head>\n\n <body class=\"oneColElsCtr\">\n\n <div id=\"container\">\n <img src=\"http://www.soluship.com/mmr/images/ic-header.jpg\" includeContext=\"true\" />\n <div id=\"mainContent\">\n <h1><SPAN style=\"color : %BUSINESSCOLOR ;\">%BUSINESSABBRIVATION SoluShip&trade;</SPAN></h1>\n <p>A shipment has been  <SPAN style=\"color : %BUSINESSCOLOR ;\"> cancelled.</span> Details are as follows.</p>\n <p>This e-mail confirms receipt of your shipment request for %ShipDate.</p>\n <p>\n <b>Ship From:</b><br/>\n Company: %SFROMCOMPANY<br/>\n Address: %SFROMADDRESS1, %SFROMADDRESS2%<br/>\n City: %SFROMCITY<br/>\n Zip/Postal Code: %SFROMZIP<br/>\n Province: %SFROMPROVINCE<br/>\n Country: %SFROMCOUNTRY<br/>\n </p>\n <p>\n <b>Ship To:</b><br/>\n Company: %STOCOMPANY<br/>\n Address: %STOADDRESS1, %STOADDRESS2%<br/>\n City: %STOCITY<br/>\n Zip/Postal Code: %STOZIP<br/>\n Province: %STOPROVINCE<br/>\n Country: %STOCOUNTRY<br/>\n </p>\n <p><b>Carrier and Service:</b> %CARRIERSERVICE</p>\n <p><b>Total Pieces:</b> %TOTALPIECES<br/>\n <b>Total Weight:</b> %TOTALWEIGHT</p>\n <p><b>Tracking Details:</b>%TRACKINGURL</br>\n </p>\n <p><b>Pickup Confirmation Number:</b>%PICKUPCONFIRMATION</br>\n </p>\n <p>Did you know you can create and track shipments and get estimates and transit times online at <a href=\"%BUSINESSLOGOUTURL\" style=\"color : %BUSINESSCOLOR ;\">%BUSINESSLOGOUTURL</a> Visit our website today and learn how our online services can benefit you.</br>\n </p>\n <p>Thank you for choosing <span style=\"color : %BUSINESSCOLOR ;\"> %BUSINESSNAME.</span></p>\n\n\n <br/>\n\n <!-- end #mainContent -->\n </div>\n <div id=\"mainFooter\">\n %FOOTER\n <!-- end #mainFooter -->\n </div>\n <!-- end #container -->\n </div>\n </body>\n </html>' WHERE `resourcebundle_id`='1685' and`msg_id`='mail.cancel.shipment.notification.body' and`locale`='en_CA' and`is_fmk`=0;
UPDATE `resourcebundle` SET `msg_content`='<html>\n<head>\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />\n<title>Welcome to  %BUSINESSABBRIVATION SoluShip&trade;</title>\n<style type=\"text/css\">\n<!--\nbody {\n	font: 100% Verdana, Arial, Helvetica, sans-serif;\n	background: #fff;\n	margin: 0;\n	padding: 0;\n	text-align: center;\n	color: #000000;\n}\n.oneColElsCtr #container {\n	width: 550px;\n	background: #FFFFFF;\n	margin: 0 auto;\n	border: 1px solid #000000;\n	text-align: left;\n	height:auto;\n}\n.oneColElsCtr #mainContent {\n	padding: 10px 10px 10px 10px;\n	font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n	font-size: 12px;\n}\n.oneColElsCtr #mainContent h1 {\n	padding: 5px 0px 0px 0px;\n	font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n	font-size: 18px;\n	color:#990000;\n}\n.oneColElsCtr #mainFooter {\n	padding: 5px 0px 0px 10px;\n	font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n	font-size: 10px;\n	color:#fff;\n	background-color:#000000;\n	height:35px;\n}\n#mainContent p{\ntext-align: left;\n}\n-->\n</style>\n</head>\n\n<body class=\"oneColElsCtr\">\n\n<div id=\"container\">\n<img src=\"http://www.soluship.com/mmr/images/ic-header.jpg\" includeContext=\"true\" />\n  <div id=\"mainContent\">\n    <h1><SPAN style=\"color : %BUSINESSCOLOR\">Welcome to %BUSINESSABBRIVATION SoluShip&trade;</SPAN></h1>\n    <p>Dear %CUSTOMERNAME,</p>\n    <p> <SPAN style=\"color : %BUSINESSCOLOR\"> Welcome to %BUSINESSABBRIVATION SoluShip&trade;.</SPAN>  To access your new web-based shipping system, please visit:</p>\n    <p><a href=\"%BUSINESSLOGOUTURL\" style=\"color : %BUSINESSCOLOR ;\">%BUSINESSLOGOUTURL</a></p>\n	<p>To begin shipping you will need to enter your User Name and Password.</p>\n    <p>Your User Name is: &nbsp;%USERNAME<br />\n    Your Password is: &nbsp;%PASSWORD</p>\n    <p>You can download the Integrated Carriers SoluShip&trade; User Quick Start Guide here:</p>\n    <p><a href=\"%BUSINESSQUICKSTARTURL\" style=\"color : %BUSINESSCOLOR ;\">%BUSINESSQUICKSTARTURL</a></p>\n    <p>If you have any questions, please contact our Company Administrator.</p>\n    <p>&nbsp;&nbsp;&nbsp;Company Administrator: Brian Dickson<br />\n	&nbsp;&nbsp;&nbsp;Phone: 416-603-0103<br />\n	&nbsp;&nbsp;&nbsp;E-mail: <a href=\"mailto:%BUSINESSADMINEMAIL\" style=\"color : %BUSINESSCOLOR ;\">%BUSINESSADMINEMAIL</a></p>\n    <p>Thank you and enjoy  <SPAN style=\"color : %BUSINESSCOLOR\">%BUSINESSABBRIVATION</SPAN> SoluShip&trade;.</p>\n	<!-- end #mainContent -->\n    </div>\n    <div id=\"mainFooter\">\n   	%FOOTER\n    <!-- end #mainFooter -->\n    </div>\n<!-- end #container -->\n</div>\n</body>\n</html>' WHERE `resourcebundle_id`='1492' and`msg_id`='message.send.customer.notification.body' and`locale`='en_CA' and`is_fmk`=0;
UPDATE `resourcebundle` SET `msg_content`='<html>\n<head>\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />\n<title>%BUSINESSABBRIVATION SoluShip&trade;</title>\n<style type=\"text/css\">\n<!--\nbody {\n	font: 100% Verdana, Arial, Helvetica, sans-serif;\n	background: #fff;\n	margin: 0;\n	padding: 0;\n	text-align: center;\n	color: #000000;\n}\n.oneColElsCtr #container {\n	width: 550px;\n	background: #FFFFFF;\n	margin: 0 auto;\n	border: 1px solid #000000;\n	text-align: left;\n	height:auto;\n}\n.oneColElsCtr #mainContent {\n	padding: 10px 10px 10px 10px;\n	font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n	font-size: 12px;\n}\n.oneColElsCtr #mainContent h1 {\n	padding: 5px 0px 0px 0px;\n	font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n	font-size: 18px;\n	color:#990000;\n}\n.oneColElsCtr #mainFooter {\n	padding: 5px 0px 0px 10px;\n	font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n	font-size: 10px;\n	color:#fff;\n	background-color:#000000;\n	height:35px;\n}\n#mainContent p{\ntext-align: left;\nmargin-left: 30px;\n}\nul{\ntext-align: left;\n}\n-->\n</style>\n</head>\n\n<body class=\"oneColElsCtr\">\n\n<div id=\"container\">\n<img src=\"http://www.soluship.com/mmr/images/ic-header.jpg\" includeContext=\"true\" />\n  <div id=\"mainContent\">\n    <h1><SPAN style=\"color : %BUSINESSCOLOR\">%BUSINESSABBRIVATION SoluShip&trade;</SPAN></h1>\n    <p>Dear %ATTENTION,</p>\n    <p>This e-mail confirms receipt of your shipment request for %ShipDate.</p>\n    <p>\n	<b>Ship From:</b><br/>\n	Company: %SFROMCOMPANY<br/>\n	Address: %SFROMADDRESS1, %SFROMADDRESS2%<br/>\n	City: %SFROMCITY<br/>\n	Zip/Postal Code: %SFROMZIP<br/>\n	Province: %SFROMPROVINCE<br/>\n	Country: %SFROMCOUNTRY<br/>\n    </p>\n    <p>\n	<b>Ship To:</b><br/>\n	Company: %STOCOMPANY<br/>\n	Address: %STOADDRESS1, %STOADDRESS2%<br/>\n	City: %STOCITY<br/>\n	Zip/Postal Code: %STOZIP<br/>\n	Province: %STOPROVINCE<br/>\n	Country: %STOCOUNTRY<br/>\n    </p>\n    <p><b>Carrier and Service:</b> %CARRIERSERVICE</p>\n	<p><b>Total Pieces:</b> %TOTALPIECES<br/>\n    <b>Total Weight:</b> %TOTALWEIGHT</p>\n    <p><b>Tracking Details:</b>%TRACKINGURL</br>\n	</p>\n	<p>Did you know you can create and track shipments and get estimates and transit times online at <a href=\"%BUSINESSLOGOUTURL\" style=\"color : %BUSINESSCOLOR\">%BUSINESSLOGOUTURL</a> Visit our website today and learn how our online services can benefit you.</br> \n	</p>\n	<p>Thank you for choosing <span style=\"color : %BUSINESSCOLOR\"> %BUSINESSNAME.</span></p>\n	\n	<br/>\n\n	<!-- end #mainContent -->\n    </div>\n    <div id=\"mainFooter\">\n   %FOOTER\n    <!-- end #mainFooter -->\n    </div>\n<!-- end #container -->\n</div>\n</body>\n</html>' WHERE `resourcebundle_id`='4590' and`msg_id`='mail.shipment.notification.body' and`locale`='en_CA' and`is_fmk`=1;
UPDATE `resourcebundle` SET `msg_content`='<html>\n<head>\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />\n<title>%BUSINESSABBRIVATION SoluShip&trade;</title>\n<style type=\"text/css\">\n<!--\nbody {\n	font: 100% Verdana, Arial, Helvetica, sans-serif;\n	background: #fff;\n	margin: 0;\n	padding: 0;\n	text-align: center;\n	color: #000000;\n}\n.oneColElsCtr #container {\n	width: 550px;\n	background: #FFFFFF;\n	margin: 0 auto;\n	border: 1px solid #000000;\n	text-align: left;\n	height:auto;\n}\n.oneColElsCtr #mainContent {\n	padding: 10px 10px 10px 10px;\n	font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n	font-size: 12px;\n}\n.oneColElsCtr #mainContent h1 {\n	padding: 5px 0px 0px 0px;\n	font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n	font-size: 18px;\n	color:#990000;\n}\n.oneColElsCtr #mainFooter {\n	padding: 5px 0px 0px 10px;\n	font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\n	font-size: 10px;\n	color:#fff;\n	background-color:#000000;\n	height:35px;\n}\n#mainContent p{\ntext-align: left;\nmargin-left: 30px;\n}\nul{\ntext-align: left;\n}\n-->\n</style>\n</head>\n\n<body class=\"oneColElsCtr\">\n\n<div id=\"container\">\n<img src=\"http://www.soluship.com/mmr/images/ic-header.jpg\" includeContext=\"true\" />\n  <div id=\"mainContent\">\n    <h1><SPAN style=\"color : %BUSINESSCOLOR ;\">%BUSINESSABBRIVATION SoluShip&trade;</SPAN></h1>\n    <p>Dear %ATTENTION,</p>\n    <p>This e-mail confirms your pick up request for %ShipDate.</p>\n    <p>You Pickup Confirmation # is <b>%CONF.</b></p>\n    <p>\n	<b>Pickup From:</b><br/>\n	Company: %SFROMCOMPANY<br/>\n	Address: %SFROMADDRESS1, %SFROMADDRESS2%<br/>\n	City: %SFROMCITY<br/>\n	Province: %SFROMPROVINCE<br/>\n	Zip/Postal Code: %SFROMZIP<br/>\n	Country: %SFROMCOUNTRY<br/>\n    </p>\n    <p>\n	<b>Pickup Details:</b><br/>\n	Ready Time: %READYHR:%READYMIN<br/>\n	Close Time: %CLOSEHR:%CLOSEMIN<br/>\n	Location: %LOCATION<br/>\n	Reference: %REFERENCE<br/>\n	Instructions: %INSTRUCTIONS<br/>\n    </p>\n    <p><b>Carrier and Service:</b> %CARRIERSERVICE</p>\n	<p><b>Total Pieces:</b> %QUANTITY<br/>\n    <b>Total Weight:</b> %TOTALWEIGHT %WEIGHTUNITS</p>\n	</p>\n	<p>Did you know you can create and track shipments and get estimates and transit times online at  <a href=\"%BUSINESSLOGOUTURL\" style=\"color : %BUSINESSCOLOR ;\">%BUSINESSLOGOUTURL</a> Visit our website today and learn how our online services can benefit you.</br>\n	</p>\n	<p>Thank you for choosing <span style=\"color : %BUSINESSCOLOR ;\"> %BUSINESSNAME.</span></p>\n\n\n	<br/>\n\n	<!-- end #mainContent -->\n    </div>\n    <div id=\"mainFooter\">\n   	%FOOTER\n    <!-- end #mainFooter -->\n    </div>\n<!-- end #container -->\n</div>\n</body>\n</html>\n' WHERE `resourcebundle_id`='1346' and`msg_id`='mail.pickup.notification.body' and`locale`='en_CA' and`is_fmk`=0;
UPDATE `resourcebundle` SET `msg_content`='<html>\r\n  <head>\r\n  <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />\r\n  <title>Thank you for using %BUSINESSABBRIVATION SoluShip&trade;</title>\r\n  <style type=\"text/css\">\r\n  <!--\r\n  body {\r\n  font: 100% Verdana, Arial, Helvetica, sans-serif;\r\n  background: #fff;\r\n  margin: 0;\r\n  padding: 0;\r\n  text-align: center;\r\n  color: #000000;\r\n  }\r\n  .oneColElsCtr #container {\r\n  width: 550px;\r\n  background: #FFFFFF;\r\n  margin: 0 auto;\r\n  border: 1px solid #000000;\r\n  text-align: left;\r\n  height:auto;\r\n  }\r\n  .oneColElsCtr #mainContent {\r\n  padding: 10px 10px 10px 10px;\r\n  font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\r\n  font-size: 12px;\r\n  }\r\n  .oneColElsCtr #mainContent h1 {\r\n  padding: 5px 0px 0px 0px;\r\n  font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\r\n  font-size: 18px;\r\n  color:#990000;\r\n  }\r\n  .oneColElsCtr #mainFooter {\r\n  padding: 5px 0px 0px 10px;\r\n  font-family: \"lucida grande\",tahoma,verdana,arial,sans-serif;\r\n  font-size: 10px;\r\n  color:#fff;\r\n  background-color:#000000;\r\n  height:35px;\r\n  }\r\n  #mainContent p{\r\n  text-align: left;\r\n  margin-left: 30px;\r\n  }\r\n  ul{\r\n  text-align: left;\r\n  }\r\n  -->\r\n  </style>\r\n  </head>\r\n  \r\n  <body class=\"oneColElsCtr\">\r\n  \r\n  <div id=\"container\">\r\n  <img src=\"http://www.soluship.com/mmr/images/ic-header.jpg\" includeContext=\"true\" />\r\n    <div id=\"mainContent\">\r\n      <h1>Thank you for using <SPAN style=\"color : %BUSINESSCOLOR\">%BUSINESSABBRIVATION SoluShip&trade;</SPAN></h1>\r\n      <p>To all concerned,</p>\r\n      <p>Please note that the follow customer has been sucessfully added to SoluShip</p>\r\n      <p>-------------------------------------------------------</p>\r\n      <p>\r\n  <b>New Account:</b><br/>\r\n Customer Name: %CUSTOMERNAME <br/>\r\n Account#: %ACCOUNT<br/>\r\n Contact Name: %CONTACTNAME<br/>\r\n Address1: %ADDRESS1<br/>\r\n  City: %CITY<br/>\r\n  Zip/Postal Code: %ZIP<br/>\r\n  Province: %PROVINCE<br/>\r\n  Country: %COUNTRY<br/>\r\n      </p>\r\n      <p>-------------------------------------------------------</p>\r\n \r\n      <p>Thank you and enjoy <span style=\"color : %BUSINESSCOLOR ;\"> %BUSINESSNAME.</span> SoluShip&trade;.</p><br/>\r\n  <!-- end #mainContent -->\r\n      </div>\r\n      <div id=\"mainFooter\">\r\n	%FOOTER\n      <!-- end #mainFooter -->\r\n      </div>\r\n  <!-- end #container -->\r\n  </div>\r\n  </body>\r\n  </html>' WHERE `resourcebundle_id`='1490' and`msg_id`='message.send.addcustomer.notification.body' and`locale`='en_CA' and`is_fmk`=1;

UPDATE `resourcebundle` SET `msg_content`='Your %BUSINESSABBRIVATION Account' WHERE `resourcebundle_id`='1494' and`msg_id`='message.send.customer.notification.subject' and`locale`='en_CA' and`is_fmk`=0;
UPDATE `resourcebundle` SET `msg_content`='Su %BUSINESSABBRIVATION cuenta' WHERE `resourcebundle_id`='8360' and`msg_id`='message.send.customer.notification.subject' and`locale`='es_MX' and`is_fmk`=0;
UPDATE `resourcebundle` SET `msg_content`='Votre compte  %BUSINESSABBRIVATION' WHERE `resourcebundle_id`='4436' and`msg_id`='message.send.customer.notification.subject' and`locale`='fr_CA' and`is_fmk`=0;
UPDATE `resourcebundle` SET `msg_content`='您的%BUSINESSABBRIVATION账户' WHERE `resourcebundle_id`='2730' and`msg_id`='message.send.customer.notification.subject' and`locale`='zh_CN' and`is_fmk`=0;


ALTER TABLE `business_contact` 
ADD COLUMN `business_contact_url` VARCHAR(200) NULL DEFAULT NULL AFTER `ltl_email`,
ADD COLUMN `business_id` INT(10) NULL DEFAULT NULL AFTER `business_contact_url`;

# uifix

ALTER TABLE `business` 
CHANGE COLUMN `default_payment_type_level` `default_payment_type_level` BIT(1) NOT NULL DEFAULT b'1' ;
.......................................End of Live server commit.......................................
